...
export default function App() {
  ...
  return (
    <div className="font-sans text-gray-800 ">
      ...
      {/* ── HERO ── */}
      <section id='home' className="relative bg-gradient-to-br from-[#0D2B5E] via-[#143870] to-[#0D2B5E] text-white overflow-hidden min-h-[560px]">
  ...
  <div className="bg-[#F7FAFF] rounded-2xl p-6 shadow-sm">
    ...
    <div className="flex items-center gap-3">
      ...
      {/* ── FOOTER ── */}
      <footer id='contact' className="bg-[#081B3E] text-blue-100 pt-14 pb-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
